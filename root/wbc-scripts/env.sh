...
OPENWRT_TOKEN_FILE=/var/run/wbc/openwrt_auth_token
OPENWRT_RESTART_TS_FILE=/var/run/wbc/openwrt_restart_timestamp
OPENWRT_CONFIG_MD5_FILE=/var/run/wbc/openwrt_config_md5
